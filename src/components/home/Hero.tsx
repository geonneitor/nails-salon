...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        style={{ opacity }}
        className="relative z-10 flex flex-col items-center px-4 md:px-12 py-16 text-center w-full max-w-4xl mt-20"
      >
        <motion.div
          initial={{ opacity: 1, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 1, ease: [0.22, 1, 0.36, 1] }}
          className="bg-white/5 backdrop-blur-xl border border-white/10 p-5 sm:p-8 md:p-16 rounded-[2.5rem] shadow-2xl w-full"
        >
          <motion.div
          ...
          >
            <Link
              href="/reserva"
              className="w-full sm:w-auto inline-flex items-center justify-center px-6 sm:px-10 py-4 rounded-full font-sans text-xs uppercase tracking-[0.15em] font-semibold bg-white text-primary hover:scale-105 transition-transform shadow-[0_0_20px_rgba(255,255,255,0.3)]"
            >
              Reservar Cita
            </Link>
            <a
              href="#servicios"
              className="w-full sm:w-auto inline-flex items-center justify-center px-6 sm:px-10 py-4 rounded-full font-sans text-xs uppercase tracking-[0.15em] font-semibold text-white border border-white/30 hover:bg-white/10 transition-colors"
            >
              Ver Menú
            </a>
          </motion.div>
