...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    content: 'Toca sobre un espacio en blanco para agendar en ese horario.',
    position: 'top',
    action: 'click_target',
  },
  {
    ...
    content: 'Navega por nuestro menú y selecciona los servicios que deseas.',
    position: 'top',
    action: 'click_target',
  },
  {
    ...
    title: 'Continuar',
    content: 'Una vez que hayas seleccionado tus servicios, presiona Continuar.',
    position: 'top',
    action: 'click_target',
  },
  {
    ...
    content: 'Selecciona la clienta y confirma la cita.',
    position: 'top',
    action: 'next',
  },
];
